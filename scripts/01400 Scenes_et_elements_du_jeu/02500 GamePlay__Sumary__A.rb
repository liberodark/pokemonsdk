  ...
  class Sumary
    ...
    class A < UI::SpriteStack
      ...
      def initialize(viewport, x = 0, y = 0, default_cache: :interface)
        ...
        @egg_stack.add_text(4, 0, 95, 20, "Mémo Dresseur", color: 8)
        @egg_stack.add_text(198, 42, 95, 20, "Infos Pokémon", color: 8)
        @egg_stack.add_text(19, 23, 66, 19, _get(0, 0), color: 8)
        @egg_phrase = @egg_stack.add_text(6, 88, 123, 16, nil.to_s)
        texts = _get_file(27)
        add_text(4, 0, 95, 20, "Mémo Dresseur", color: 8)
        add_text(198, 42, 95, 20, "Infos Pokémon", color: 8)
