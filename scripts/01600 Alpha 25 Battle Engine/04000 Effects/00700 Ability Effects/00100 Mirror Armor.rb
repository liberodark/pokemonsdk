      ...
      class MirrorArmor < Ability
        ...
        def on_stat_decrease_prevention(handler, stat, target, launcher, skill)
          ...
          return handler.prevent_change do
            ...
            skill.battle_stage_mod.each do |stage|
              handler.logic.stat_change_handler.stat_change_with_process(stat, stage.count, launcher, target, skill) if stage.stat == stat
            end
          end
        end
      end
