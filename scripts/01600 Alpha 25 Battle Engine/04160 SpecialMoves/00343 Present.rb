#40% to do 40 base power, 30% for 80 base power, 10% for 120 base power, 20% to heal target by 1/4 of their max HP.
#Heal block does not prevent move from working, just won't heal if it gets that roll.
#Max HP will prevent healing (obviously).
module Battle
    class Move
